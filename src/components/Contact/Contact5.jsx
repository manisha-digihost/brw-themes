      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col gap-5 md:flex md:flex-row">
          <div className="w-full">
            <h1 className="text-6xl font-black uppercase pb-[50px]">Let’s connect support team</h1>
            <span className="text-red-500 border-b-4 border-red-500 text-2xl font-semibold">Contact with us</span>
            <div className="pt-[50px] flex flex-wrap gap-5 items-center">
              <span className="text-xl font-semibold"><FaLocationDot /></span>
              <a href="#!" className="text-xl font-semibold"> 1 800 222 4357</a>
            </div>
            <div className="flex flex-wrap gap-5 items-center mt-5">
              <span className="text-xl font-semibold"><FaPhone /></span>
              <p className="text-xl font-semibold"> 25 Palmal Stree, London, England</p>
            </div>

            <div className="flex flex-wrap gap-5 items-center mt-5">
              <span className="text-xl font-semibold"><IoMdMail /></span>
              <a href="#!" className="text-xl font-semibold"> webtend24@gmail.com</a>
            </div>
          </div>
          <div className="w-full">
          ...
          <a href="#!" className="inline-block mt-5 px-10 py-5 text-white font-bold transition duration-300 hover:bg-green-600 bg-red-600">Send Message</a>
